...
class LycanthropePatientTest {
    @Test
    public void testGetRace() {
        CreaturePatient patient = new LycanthropePatient("Patient", "M", 77f, 182f, 38, new ArrayList<>(), 10);
        assertEquals("Lycanthrope", patient.getRace());
    }
